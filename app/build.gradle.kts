...
android {
    namespace = "ac.id.ub.filkom.dugdugsehat"
    compileSdk = 34

    defaultConfig {
        applicationId = "ac.id.ub.filkom.dugdugsehat"
        minSdk = 24
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    //Vico Chart Dependencies
    val vico_version = "1.13.0"
    //including the core logic for charts and other elements.
